...
<html>
<head>
    <title>Work Logs > Open Jobs</title>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="text_block"><span class="title purple">Open Jobs</span><a href="<?php echo uri('/jobs/closed'); ?>"><img src="<?php echo asset('images/appbar.sort.png'); ?>" /></a></div>
            <div>
